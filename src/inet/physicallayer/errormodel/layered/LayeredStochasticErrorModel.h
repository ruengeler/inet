...
#ifndef __INET_LAYEREDSTOCHASTICERRORMODEL_H
#define __INET_LAYEREDSTOCHASTICERRORMODEL_H
...
class INET_API LayeredStochasticErrorModel : public LayeredErrorModelBase
{
  protected:
