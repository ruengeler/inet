...
#ifndef __INET_LAYEREDCONSTANTERRORMODEL_H
#define __INET_LAYEREDCONSTANTERRORMODEL_H
...
class INET_API LayeredConstantErrorModel : public LayeredErrorModelBase
{
  protected:
...
#endif // ifndef __INET_LAYEREDCONSTANTERRORMODEL_H
