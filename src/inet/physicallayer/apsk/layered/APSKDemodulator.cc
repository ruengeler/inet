...
APSKDemodulator::APSKDemodulator(const Ieee80211OFDMModulation *ofdmModulation) :
...
APSKDemodulator::APSKDemodulator(const APSKModulationBase* demodulationScheme) :
        ofdmModulation(NULL),
